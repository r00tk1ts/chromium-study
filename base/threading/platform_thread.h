...
class PlatformThreadHandle {
 public:
  ...
  bool is_equal(const PlatformThreadHandle& other) const { return handle_ == other.handle_; }

  bool is_null() const { return !handle; }
...
class PlatformThread {
 public:
  ...
  static bool CreateNonJoinableWithPriority(size_t stack_size, Delegate* delegate,
  ...
  static void SetThreadPriority(PlatformThreadId thread_id, ThreadPriority priority);
